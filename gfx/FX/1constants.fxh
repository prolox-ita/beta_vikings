...
static const float CITY_LIGHTS_INTENSITY 		= 0.5;
...
static const float BORDER_FOW_REMOVAL_FACTOR = 0.4f; // How much of the FOW that is removed from the borders. 1.0f is no FOW
...
static const float GB_STRENGTH_CH1 = 0.65; // Opacity of bottom layer
...
static const float BORDER_MAP_TILE = 36000.0f;
